<?php
/**
 * WooCommerce PDF Invoices Template Settings
 *
 * @author      Bas Elbers
 * @category    Admin
...
if ( ! class_exists( 'BEWPI_Settings_Template' ) ) :

/**
 * BEWPI_Admin_Settings_General.
 */
class BEWPI_Settings_Template extends BEWPI_Settings_Page {
	...
	public function get_sections() {
		...
		$sections = array(
			...
			'number'       => __( 'Invoice Number', 'woocommerce-pdf-invoices' ),
		);
	...
	public function get_settings( $current_section = '' ) {
		if ( $current_section === 'number' ) {
			...
			$settings = apply_filters( 'bewpi_template_settings', array(
				...
				// General Options
				array( 'title' => __( 'Template Options', 'woocommerce-pdf-invoices' ), 'type' => 'title', 'desc' => '', 'id' => 'general_options' ),
...
return new BEWPI_Settings_Template();
