...
if ( class_exists( 'BEWPI_Template' ) ) {
	return;
}
...
class BEWPI_Template extends BEWPI_Settings_API {
	...
	public function admin_options() {
		...
		$this->admin_actions();
		?>
		<h2><?php echo esc_html( $this->get_title() ); ?> <?php wc_back_link( __( 'Return to Emails', 'woocommerce' ), admin_url( 'admin.php?page=bewpi-settings&tab=templates' ) ); ?></h2>
